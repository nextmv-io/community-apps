# Nextmv Python PySCIPOpt Knapsack

Example for running a Python application on the Nextmv Platform using the SCIP
solver. We solve a knapsack Binary Programming problem.
