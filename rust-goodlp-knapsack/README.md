...
This app solves the knapsack problem using the
[good_lp](https://crates.io/crates/good_lp) crate.

## Prerequisites

- [Docker](https://docs.docker.com/get-docker/)
- [Rust](https://www.rust-lang.org/tools/install)
- Some dependencies for building HiGHS as the underlying solver. On Ubuntu, you
